...
def index(artist_name):
    ...
    banner_image = get_banner_image(artist)
    return render_template('index.html', songs=songs, banner_image=banner_image, artist_name=artist["name"])


def get_banner_image(artist):
